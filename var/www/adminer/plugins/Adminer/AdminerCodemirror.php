...
class AdminerCodemirror
{
	...
	function __construct($root = "static/codemirror5")
	{
		$this->root = $root;
	}
...
?>
		...
		<?php
		echo script_src("$this->root/lib/codemirror.js");
		echo script_src("$this->root/addon/runmode/runmode.js");
		echo script_src("$this->root/addon/hint/show-hint.js");
		echo script_src("$this->root/mode/javascript/javascript.js");
		if (support("sql")) {
			echo script_src("$this->root/mode/sql/sql.js");
			echo script_src("$this->root/addon/hint/sql-hint.js");
		}
		$tables = array();

...
class AdminerBackwardKeys
{
    protected $translations = [
        'cs' => ['' => 'Zobrazí odkazy na tabulky odkazující aktuální řádek, stejně jako Adminer Editor'],
        'de' => ['' => 'Links zu Tabellen anzeigen die auf die aktuelle Zeile verweisen, wie im Adminer Editor'],
        'ja' => ['' => 'Adminer Editor と同様に、カレント行を参照しているテーブルへのリンクを表示'],
        'pl' => ['' => 'Wyświetlaj linki do tabel odnoszących się do bieżącego wiersza, tak samo jak w Edytorze administratora'],
    ];

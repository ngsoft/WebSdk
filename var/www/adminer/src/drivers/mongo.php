...
if (isset($_GET['mongo']))
{
    ...
    if (class_exists('MongoDB\Driver\Manager'))
    {
        class Db extends SqlDb
        {
            ...
            public function executeDbCommand($db, array $command)
            {
                try
                {
            ...
            public function executeBulkWrite($namespace, \MongoDB\Driver\BulkWrite $bulk, $counter)
            {
                try
                {
        ...
        function where_to_query(array $whereAnd = [], array $whereOr = [])
        {
            $data = [];

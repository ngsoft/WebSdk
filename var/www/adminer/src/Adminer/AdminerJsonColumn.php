 ...
 */
class AdminerJsonColumn extends Plugin
{
    protected $translations = [
        'cs' => ['' => 'Hodnoty JSON v editaci zobrazí formou tabulky'],
        'de' => ['' => 'Zeigen Sie JSON-Werte als Tabelle in der Bearbeitung an'],
        'pl' => ['' => 'Wyświetl wartości JSON jako tabelę w edycji'],
        'ro' => ['' => 'Afișează valorile JSON sub formă de tabel în editare'],
        'ja' => ['' => 'JSON 値をテーブルとして編集画面に表示'],
    ];

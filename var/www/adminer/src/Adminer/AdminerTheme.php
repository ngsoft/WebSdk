 ...
 *
 * @see https://github.com/pematon/adminer-theme
 *
 * @author Peter Knut
...
class AdminerTheme
{
    ...
    public function head()
    {
        ...
        if (false !== strpos($userAgent, 'Windows')):
            ?>
        ...
        <?php elseif (false !== strpos($userAgent, 'iPhone') || false !== strpos($userAgent, 'iPad')): ?>
            <link rel="apple-touch-icon-precomposed"
                  href="<?= $basepath; ?>images/touchIcon.png?<?= self::ICONS_VERSION; ?>"/>

        <?php elseif (false !== strpos($userAgent, 'Android')): ?>
            <link rel="apple-touch-icon-precomposed"
                  href="<?= $basepath; ?>images/touchIcon-android.png?<?= self::ICONS_VERSION; ?>"/>

        <?php else: ?>
            <link rel="apple-touch-icon" href="<?= $basepath; ?>images/touchIcon.png?<?= self::ICONS_VERSION; ?>"/>
        <?php endif; ?>

        <link rel="stylesheet" type="text/css"
              href="<?= $basepath; ?>css/<?= htmlspecialchars($this->themeName); ?>.css?<?= self::CSS_VERSION; ?>">
        <link rel="stylesheet" type="text/css"

 ...
 */
class AdminerPrettyJsonColumn extends Plugin
{
    public function editInput($table, $field, $attrs, $value)
    {
        ...
        if ($json !== $value)
        {
            ...
            return "<textarea{$attrs} cols='50' rows='20' class='jush-js json-column'>" . h($jsonText) . '</textarea>';
        }
    }
